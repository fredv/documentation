...
We are going to use [the MySQLs Add-on's free plan](https://www.cloudcontrol.com/dev-center/add-on-documentation/data-storage/mysqls). It provides a free shared database for testing and development.
